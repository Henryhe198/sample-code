...
return {
	...
	require(['ImageMethod','imgloads'], function (im, imgLoad) {
	    ...
	    $('body').on('tap', '.Related_Centent', function () {
	        $this = $(this);
	        window.location.href = '/News/SpecialTemplate?id=' + $this.data('id');
	    })
	    $(function () {
	        //function fhFn_close() {
	        //    var url = Consts.h5Domin + 'Broker/EvaluatePeriod?id=' + WinUrlId;
	        //    $('#fh_Eval').attr('href', url);
	        //}
	        $('#fh_Eval').on('click', function () {
	            //var url = Consts.H5Domain + 'Broker/EvaluatePeriod?id=' + WinUrlId;
	            //var url = 'http://apph5.fx001.com/Broker/EvaluatePeriod?id=' + WinUrlId;
	    ...
	    $.ajax({
	        type: 'GET',
	        url: Consts.OKRUrl148 + 'api/SpecialMobileApi?specialId=' + WinUrlId,
	        ...
	        success: function (data) {
	            ...
	            if (data.code == 0) {
	                if (data.bodyMessage && data.bodyMessage != "null") {
	                    ...
	                    if (dataCen.Title && dataCen.MContent) {
	                    ...
	                    if (dataCen.More) {
	                        ...
	                        for (var i = 0; i < DataMore.length; i++) {
	                            News += '<div class="Related_Centent" data-id="' + DataMore[i].SpecialId + '">';
	                            News += '<a href="/News/SpecialTemplate?id=' + DataMore[i].SpecialId + '">';
...
define("DetailsTemplateSpecial", function(){});
