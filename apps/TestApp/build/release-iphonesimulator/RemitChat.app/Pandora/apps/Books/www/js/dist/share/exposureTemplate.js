...
require(['vue', 'IsLoadMethod','molieInit'], function (vue, IsLoadMethod,init) {
	...
	$.ajax({
		type: 'GET',
		url:Consts.FXUrl + '/api/RightsExposureApi/' + consultId,
		data: {},
		cache:true,
		dataType: 'json',
    ...
    function getComments() {
    	var url = Consts.FXUrl + '/api/CommentMobileApi?type=%E6%9B%9D%E5%85%89&aboutId=' + consultId + '&scoreType=%E5%85%A8%E9%83%A8&pageIndex=1&pageSize=3';
        mui.ajax(url, {
			data: {},
...
define("exposureTemplate", function(){});
