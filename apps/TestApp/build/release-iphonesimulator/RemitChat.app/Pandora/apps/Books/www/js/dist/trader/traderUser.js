...
require(['vue','booksMethod'], function (vue,bk) {
    ...
    $("body").on("tap", ".zh-list li", function () {
    	if(vm.onLine){
			//打开页面
			mui.openWindow({
    ...
    traderUser(uId);
    function traderUser(uId) {
        $.ajax({
            type: "get",
            url: Consts.OKRUrl148 + 'api/TradeUserApi?accountStatus=1&isPostFTP=true&userId=' + uId,
            dataType: 'json',
