...
require(['vue','booksMethod'], function(vue,bk) {
	if(mui.os.ios) {
		$("header").css({ "padding-top": "20px", "height": "64px !important"});
	...
	var url = Consts.OKRUrl + 'api/FX_BonusMallRuleApi?MallId='+ id;
	mui.ajax(url, {
		data: {},
