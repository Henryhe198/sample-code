...
require(['ImageMethod','imgloads'], function (im,imgLoad) {
    ...
    $('body').on('tap', '.Related_Centent', function () {
        $this = $(this);
        window.location.href = '/News/InfoTemplate?id=' + $this.data('id');
    })
    $(function () {
        //function fhFn_close() {
    ...
    $.ajax({
        type: 'GET',
        url: Consts.OKRUrl148 + 'api/BrokerNewsMobile/' + WinUrlId,
                ...
                if (data.bodyMessage && data.bodyMessage != "null") {
                    ...
                    if (dataCen.More) {
                        ...
                        for (var i = 0; i < DataMore.length; i++) {
                            ...
                            News += '<a href="/News/InfoTemplate?id=' + DataMore[i].SpecialId + '">';
                        ...
                        document.getElementById('Related_news').style.display = 'none';
                    }
...
define("DetailsTemplateInfo", function(){});
