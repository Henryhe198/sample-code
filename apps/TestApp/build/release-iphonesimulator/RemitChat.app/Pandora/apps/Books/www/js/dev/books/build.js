////CMD 命令   node r.js -o dev/books/build.js
({
	...
	modules: [{
			...
			name: 'booksDetails', //模块 
			include: [], //将 Basic_Information和 App 的模块打包成一个文件   （文件不依赖App但是还是把App打包进去）
			exclude: [] //  // 将 Basic_Information 及其依赖项一并打包，但不包括 []里面的
				// 排除指定模块，但若该模块对所打包文件有级联依赖关系，则仍会被打包进去
				// excludeShallow: ["App"]
		}, {
			name: 'booksComments', //模块 
			include: [], //将 Basic_Information和 App 的模块打包成一个文件   （文件不依赖App但是还是把App打包进去）
			exclude: [] //  // 将 Basic_Information 及其依赖项一并打包，但不包括 []里面的
				// 排除指定模块，但若该模块对所打包文件有级联依赖关系，则仍会被打包进去
				// excludeShallow: ["App"]
	...
	paths: {
		//页面js
		booksIndex: "../books/booksIndex",
		booksIntroduction: "../books/booksIntroduction",
		booksList: "../books/booksList",
		booksDetails: "../books/booksDetails",
		booksComments: "../books/booksComments",
		booksSubmitComment: "../books/booksSubmitComment",
		...
		zepto: "../../gulp/zepto/zepto",
		onLine: "../../gulp/onLine/onLine",
		booksMethod: "../../gulp/moblie/booksMethod",
		molieInit:"../../gulp/moblie/molieInit",
		touchs:"../../gulp/moblie/touch",
		Ios:"../../gulp/moblie/Ios",
		Android:"../../gulp/moblie/Android"
		
	},
	shim: {
		'booksIndex': ['zepto','getQueryString','onLine'],
		'booksIntroduction': ['mui','zepto', 'getQueryString','onLine'],
		'booksList': ['mui','zepto', 'getQueryString','onLine'],
		'booksDetails': ['mui','zepto', 'getQueryString','zoom','previewimage','onLine'],
		'booksComments': ['mui','zepto', 'getQueryString','onLine'],
		'booksSubmitComment': ['mui','zepto','getQueryString','onLine']
	}
