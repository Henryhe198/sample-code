...
require(['vue','booksMethod'], function(vue,bk) {
	...
	$('body').on('tap', '.Related_Centent', function() {
		if(vm.onLine){
			mui.openWindow({
				url: 'specialTemplate.html?id=' + $(this).data('id'),
				extras: {}
			});	
		}else{
			mui.toast("网络未连接，请检查网络！")
	...
	$.ajax({
		type: 'GET',
		url: Consts.OKRUrl148 + 'api/SpecialMobileApi?specialId=' + id,
		data: {},
		cache:true,
		dataType: 'json',
...
define("specialTemplate", function(){});
