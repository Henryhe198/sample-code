...
require(['vue', 'IsLoadMethod','molieInit'], function (vue, IsLoadMethod,init) {
	...
	$.ajax({
		type: 'GET',
		url:Consts.FXUrl + '/api/RightsComplaintApi/' + consultId,
		data: {},
		cache:true,
		dataType: 'json',
    ...
    function getComments() {
    	var url = Consts.FXUrl + '/api/CommentMobileApi?type=%E6%8A%95%E8%AF%89&aboutId=' + consultId + '&scoreType=%E5%85%A8%E9%83%A8&pageIndex=1&pageSize=3';
        mui.ajax(url, {
			data: {},
...
define("complaintTemplate", function(){});
